...
public class ArenaInputActionHandler : MonoBehaviour
{
    public static ArenaInputActionHandler Instance { get; private set; }
    ...
    public void ProcessAction_Gamepad(GamePadControllerEnum action)
    {
        ...
        switch (action)
        {
            ...
            case GamePadControllerEnum.Up:
                ...
                break;
            case GamePadControllerEnum.Left:
                //                Debug.Log(action);
                Action_CycleMenuLeft();
                break;
            case GamePadControllerEnum.Right:
                //                               Debug.Log(action);
                Action_CycleMenuRight();
                break;
    ...
    {
      ArenaMenuNavigation.Instance.IncrementSelection();
    }
    public void Action_CycleMenuBackwards()
    {
       ArenaMenuNavigation.Instance.DecrementSelection();
    }
    public void Action_CycleMenuLeft()
    {
               ArenaMenuNavigation.Instance.DecrementSelection_Lateral();
    }
    public void Action_CycleMenuRight()
    {
               ArenaMenuNavigation.Instance.IncrementSelection_Lateral();
    }
    public void Action_ActivateSelectedButton()
    {

        ArenaMenuNavigation.Instance.ActivateSelectedButton();
    }
    public void Action_BackOutOfMenu()
    {

        ArenaMenuNavigation.Instance.BackOutOfMenu();
    }
