...
{
    public static InputActionHandler Instance { get; private set; }
...
//                Debug.Log(action);
 ...
 //       Debug.Log($"{mouseDetection.Item1} : {mouseDetection.Item2}");
...
//                Debug.Log(action);
 ...
 //       Debug.Log(actions.Count);
    ...
    {
        BattleMenuNavigation.Instance.DecrementSelection();
    }
    public void Action_ActivateSelectedButton()
    {

        BattleMenuNavigation.Instance.ActivateSelectedButton();
    }
    public void Action_BackOutOfMenu()
    {

        BattleMenuNavigation.Instance.BackOutOfMenu();
    }
    public void Action_LeftBumperCycle() 
    {
        Battle_Class.Instance.BumperCycleBackward_SelectedUnitIndex();
    }
    public void Action_RightBumperCycle()
    {
        Battle_Class.Instance.BumperCycleForward_SelectedUnitIndex();
    }

    public void Action_CycleUpSelectionDropdown() 
    {
        TargetSelectionDropdown.Instance.CycleUp();
    }
    public void Action_CycleDownSeclectionDropdown() 
    {
        TargetSelectionDropdown.Instance.CycleDown();
    }

    public void Action_RightJoystickClick() 
    {
        TargetingReticule.Instance.SimulateClick();
    }
    public void Action_LeftJoystickClick()
    {
    ...
    public int DynamicMouseSizeDetection_Int(string button)
    {
        ...
        {
            Debug.Log($"Invalid number string | {button}.");
            return -1;
        }
    }
